...
function App() {
  ...
  function generarAcciones(): { id:string;urgencia:string;titulo:string;desc:string;color:string;url:string;icono?:string;secundaria?:boolean }[] {
    ...
    if (sit.includes("18") || sit.includes("cumpl")) acciones.push({ id:"dni", urgencia:"Trámite prioritario", titulo:"Renueva tu DNI", desc:"Necesario para todos los trámites. Cita en interior.gob.es.", color:"#A29BFE", url:"https://www.interior.gob.es", icono:"🪪", secundaria:acciones.length > 0 });
    ...
    if (sit.includes("trabajo") || sit.includes("emple")) acciones.push({ id:"ss", urgencia:"Antes de empezar a trabajar", titulo:"Comprueba tu alta en la Seguridad Social", desc:"Comprueba que tu empresa te da de alta en la Seguridad Social el primer día — es obligatorio.", color:"#74B9FF", url:"https://www.seg-social.es", icono:"💼", secundaria:acciones.length > 0 });
